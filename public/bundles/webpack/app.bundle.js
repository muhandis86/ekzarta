...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__holder_js__ = __webpack_require__(4);
...
__WEBPACK_IMPORTED_MODULE_0__holder_js__["a" /* default */].ChangeDetails = ChangeDetails;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__holder_js__ = __webpack_require__(4);
...
function normalizePrepare(prep) {
  return Array.isArray(prep) ? prep : [prep, new __WEBPACK_IMPORTED_MODULE_0__change_details_js__["a" /* default */]()];
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_continuous_tail_details_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_holder_js__ = __webpack_require__(4);
...
class Masked {
  ...
  */
  ...
  extractTail() {
    let fromPos = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    let toPos = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.value.length;
    return new __WEBPACK_IMPORTED_MODULE_1__core_continuous_tail_details_js__["a" /* default */](this.extractInput(fromPos, toPos), fromPos);
  }

  /** Appends tail */
  // $FlowFixMe no ideas
  appendTail(tail) {
    if (Object(__WEBPACK_IMPORTED_MODULE_2__core_utils_js__["d" /* isString */])(tail)) tail = new __WEBPACK_IMPORTED_MODULE_1__core_continuous_tail_details_js__["a" /* default */](String(tail));
    return tail.appendTo(this);
  }

  /** Appends char */
  _appendCharRaw(ch) {
    if (!ch) return new __WEBPACK_IMPORTED_MODULE_0__core_change_details_js__["a" /* default */]();
    this._value += ch;
    return new __WEBPACK_IMPORTED_MODULE_0__core_change_details_js__["a" /* default */]({
      inserted: ch,
      rawInserted: ch
    });
  }
  ...
  _appendChar(ch) {
    ...
    let details;
    [ch, details] = Object(__WEBPACK_IMPORTED_MODULE_2__core_utils_js__["e" /* normalizePrepare */])(this.doPrepare(ch, flags));
    ...
    if (details.inserted) {
      ...
      if (!appended) {
        details = new __WEBPACK_IMPORTED_MODULE_0__core_change_details_js__["a" /* default */]();
  ...
  append(str, flags, tail) {
    if (!Object(__WEBPACK_IMPORTED_MODULE_2__core_utils_js__["d" /* isString */])(str)) throw new Error('value should be string');
    const details = new __WEBPACK_IMPORTED_MODULE_0__core_change_details_js__["a" /* default */]();
    const checkTail = Object(__WEBPACK_IMPORTED_MODULE_2__core_utils_js__["d" /* isString */])(tail) ? new __WEBPACK_IMPORTED_MODULE_1__core_continuous_tail_details_js__["a" /* default */](String(tail)) : tail;
  ...
  */
  ...
  splice(start, deleteCount, inserted, removeDirection) {
    ...
    let oldRawValue;
    if (eagerRemove) {
      removeDirection = Object(__WEBPACK_IMPORTED_MODULE_2__core_utils_js__["c" /* forceDirection */])(removeDirection);
    ...
    if (removeDirection !== __WEBPACK_IMPORTED_MODULE_2__core_utils_js__["a" /* DIRECTION */].NONE) {
      startChangePos = this.nearestInputPos(start, deleteCount > 1 && start !== 0 && !eagerRemove ? __WEBPACK_IMPORTED_MODULE_2__core_utils_js__["a" /* DIRECTION */].NONE : removeDirection);

      // adjust tailShift if start was aligned
      details.tailShift = startChangePos - start;
    }
    details.aggregate(this.remove(startChangePos));
    if (eagerRemove && removeDirection !== __WEBPACK_IMPORTED_MODULE_2__core_utils_js__["a" /* DIRECTION */].NONE && oldRawValue === this.rawInputValue) {
      if (removeDirection === __WEBPACK_IMPORTED_MODULE_2__core_utils_js__["a" /* DIRECTION */].FORCE_LEFT) {
        let valLength;
        while (oldRawValue === this.rawInputValue && (valLength = this.value.length)) {
          details.aggregate(new __WEBPACK_IMPORTED_MODULE_0__core_change_details_js__["a" /* default */]({
            tailShift: -1
          })).aggregate(this.remove(valLength - 1));
        }
      } else if (removeDirection === __WEBPACK_IMPORTED_MODULE_2__core_utils_js__["a" /* DIRECTION */].FORCE_RIGHT) {
        tail.unshift();
      }
    }
...
__WEBPACK_IMPORTED_MODULE_3__core_holder_js__["a" /* default */].Masked = Masked;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_holder_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_change_details_js__ = __webpack_require__(7);
...
function maskedClass(mask) {
  ...
  // $FlowFixMe
  if (mask instanceof RegExp) return __WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].MaskedRegExp;
  // $FlowFixMe
  if (Object(__WEBPACK_IMPORTED_MODULE_0__core_utils_js__["d" /* isString */])(mask)) return __WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].MaskedPattern;
  // $FlowFixMe
  if (mask instanceof Date || mask === Date) return __WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].MaskedDate;
  // $FlowFixMe
  if (mask instanceof Number || typeof mask === 'number' || mask === Number) return __WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].MaskedNumber;
  // $FlowFixMe
  if (Array.isArray(mask) || mask === Array) return __WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].MaskedDynamic;
  // $FlowFixMe
  if (__WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].Masked && mask.prototype instanceof __WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].Masked) return mask;
  // $FlowFixMe
  if (mask instanceof __WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].Masked) return mask.constructor;
  // $FlowFixMe
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__rollupPluginBabelHelpers_6b3bd404_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__factory_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_holder_js__ = __webpack_require__(4);
...
class PatternInputDefinition {
  ...
  constructor(opts) {
    const {
      ...
      maskOpts = Object(__WEBPACK_IMPORTED_MODULE_0__rollupPluginBabelHelpers_6b3bd404_js__["a" /* _ */])(opts, _excluded);
    this.masked = Object(__WEBPACK_IMPORTED_MODULE_1__factory_js__["a" /* default */])(maskOpts);
    Object.assign(this, {
      parent,
      isOptional,
      placeholderChar,
  ...
  _appendPlaceholder() {
    const details = new __WEBPACK_IMPORTED_MODULE_2__core_change_details_js__["a" /* default */]();
  ...
  nearestInputPos(cursorPos) {
    let direction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : __WEBPACK_IMPORTED_MODULE_3__core_utils_js__["a" /* DIRECTION */].NONE;
    const minPos = 0;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_continuous_tail_details_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_holder_js__ = __webpack_require__(4);
...
class PatternFixedDefinition {
  ...
  nearestInputPos(cursorPos) {
    let direction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : __WEBPACK_IMPORTED_MODULE_1__core_utils_js__["a" /* DIRECTION */].NONE;
    const minPos = 0;
  ...
  extractTail() {
    ...
    return new __WEBPACK_IMPORTED_MODULE_2__core_continuous_tail_details_js__["a" /* default */]('');
  }

  // $FlowFixMe no ideas
  appendTail(tail) {
    if (Object(__WEBPACK_IMPORTED_MODULE_1__core_utils_js__["d" /* isString */])(tail)) tail = new __WEBPACK_IMPORTED_MODULE_2__core_continuous_tail_details_js__["a" /* default */](String(tail));
    return tail.appendTo(this);
  }
  append(str, flags, tail) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__rollupPluginBabelHelpers_6b3bd404_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_continuous_tail_details_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_holder_js__ = __webpack_require__(4);
...
class ChunksTailDetails {
  ...
  appendTo(masked) {
    ...
    if (!(masked instanceof __WEBPACK_IMPORTED_MODULE_4__core_holder_js__["a" /* default */].MaskedPattern)) {
      const tail = new __WEBPACK_IMPORTED_MODULE_3__core_continuous_tail_details_js__["a" /* default */](this.toString());
      return tail.appendTo(masked);
    }
    const details = new __WEBPACK_IMPORTED_MODULE_1__core_change_details_js__["a" /* default */]();
  ...
  set state(state) {
    const {
      ...
      props = Object(__WEBPACK_IMPORTED_MODULE_0__rollupPluginBabelHelpers_6b3bd404_js__["a" /* _ */])(state, _excluded);
    Object.assign(this, props);
    this.chunks = chunks.map(cstate => {
      const chunk = "chunks" in cstate ? new ChunksTailDetails() : new __WEBPACK_IMPORTED_MODULE_3__core_continuous_tail_details_js__["a" /* default */]();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_holder_js__ = __webpack_require__(4);
...
class PatternCursor {
  ...
  pushLeftBeforeFilled() {
    return this._pushLeft(() => {
      ...
      this.offset = this.block.nearestInputPos(this.offset, __WEBPACK_IMPORTED_MODULE_0__core_utils_js__["a" /* DIRECTION */].FORCE_LEFT);
  ...
  pushLeftBeforeInput() {
    ...
    return this._pushLeft(() => {
      ...
      this.offset = this.block.nearestInputPos(this.offset, __WEBPACK_IMPORTED_MODULE_0__core_utils_js__["a" /* DIRECTION */].LEFT);
      return true;
    });
  }
  ...
  pushRightBeforeFilled() {
    return this._pushRight(() => {
      if (this.block.isFixed || !this.block.value) return;
      this.offset = this.block.nearestInputPos(this.offset, __WEBPACK_IMPORTED_MODULE_0__core_utils_js__["a" /* DIRECTION */].FORCE_RIGHT);
  ...
  pushRightBeforeInput() {
    return this._pushRight(() => {
      ...
      // const o = this.offset;
      this.offset = this.block.nearestInputPos(this.offset, __WEBPACK_IMPORTED_MODULE_0__core_utils_js__["a" /* DIRECTION */].NONE);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_holder_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_continuous_tail_details_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_utils_js__ = __webpack_require__(9);
...
/** Masking by RegExp */
class MaskedRegExp extends __WEBPACK_IMPORTED_MODULE_0__base_js__["a" /* default */] {
  /**
    @override
    @param {Object} opts
  */
...
__WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].MaskedRegExp = MaskedRegExp;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__base_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pattern_input_definition_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pattern_fixed_definition_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pattern_chunk_tail_details_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pattern_cursor_js__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__factory_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__core_holder_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__regexp_js__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__core_continuous_tail_details_js__ = __webpack_require__(12);
...
*/
class MaskedPattern extends __WEBPACK_IMPORTED_MODULE_3__base_js__["a" /* default */] {
  /** */
  ...
  _rebuildMask() {
    ...
    for (let i = 0; i < pattern.length; ++i) {
      ...
      if (this.blocks) {
        ...
        if (bName) {
          // $FlowFixMe no ideas
          const maskedBlock = Object(__WEBPACK_IMPORTED_MODULE_8__factory_js__["a" /* default */])(Object.assign({
            parent: this,
            lazy: this.lazy,
            eager: this.eager,
      ...
      const maskOpts = (_defs$char = defs[char]) !== null && _defs$char !== void 0 && _defs$char.mask && !(((_defs$char2 = defs[char]) === null || _defs$char2 === void 0 ? void 0 : _defs$char2.mask.prototype) instanceof __WEBPACK_IMPORTED_MODULE_9__core_holder_js__["a" /* default */].Masked) ? defs[char] : {
        mask: defs[char]
      };
      const def = isInput ? new __WEBPACK_IMPORTED_MODULE_4__pattern_input_definition_js__["b" /* default */](Object.assign({
        parent: this,
        ...
        placeholderChar: this.placeholderChar,
        displayChar: this.displayChar
      }, maskOpts)) : new __WEBPACK_IMPORTED_MODULE_5__pattern_fixed_definition_js__["a" /* default */]({
        char,
        eager: this.eager,
  ...
  */
  ...
  set state(state) {
    const {
      ...
      maskedState = Object(__WEBPACK_IMPORTED_MODULE_0__rollupPluginBabelHelpers_6b3bd404_js__["a" /* _ */])(state, _excluded);
  ...
  */
  extractTail() {
    let fromPos = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    let toPos = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.value.length;
    const chunkTail = new __WEBPACK_IMPORTED_MODULE_6__pattern_chunk_tail_details_js__["a" /* default */]();
  ...
  */
  nearestInputPos(cursorPos) {
    ...
    const cursor = new __WEBPACK_IMPORTED_MODULE_7__pattern_cursor_js__["a" /* default */](this, cursorPos);
    ...
    if (direction === __WEBPACK_IMPORTED_MODULE_1__core_utils_js__["a" /* DIRECTION */].RIGHT || direction === __WEBPACK_IMPORTED_MODULE_1__core_utils_js__["a" /* DIRECTION */].FORCE_RIGHT) {
      ...
      if (direction === __WEBPACK_IMPORTED_MODULE_1__core_utils_js__["a" /* DIRECTION */].FORCE_RIGHT) return this.value.length;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_holder_js__ = __webpack_require__(4);
...
__WEBPACK_IMPORTED_MODULE_0__core_holder_js__["a" /* default */].MaskElement = MaskElement;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pattern_js__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_holder_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__rollupPluginBabelHelpers_6b3bd404_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__base_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_continuous_tail_details_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pattern_input_definition_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__factory_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pattern_fixed_definition_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pattern_chunk_tail_details_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pattern_cursor_js__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__regexp_js__ = __webpack_require__(48);
...
class MaskedRange extends __WEBPACK_IMPORTED_MODULE_0__pattern_js__["a" /* default */] {
  /**
  ...
  */
  doPrepare(ch) {
    let flags = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    let details;
    [ch, details] = Object(__WEBPACK_IMPORTED_MODULE_2__core_utils_js__["e" /* normalizePrepare */])(super.doPrepare(ch.replace(/\D/g, ''), flags));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mask_element_js__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_holder_js__ = __webpack_require__(4);



/** Bridge between HTMLElement and {@link Masked} */
class HTMLMaskElement extends __WEBPACK_IMPORTED_MODULE_0__mask_element_js__["a" /* default */] {
...
__WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].HTMLMaskElement = HTMLMaskElement;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__holder_js__ = __webpack_require__(4);
...
class ActionDetails {
  ...
  */
  get removeDirection() {
    if (!this.removedCount || this.insertedCount) return __WEBPACK_IMPORTED_MODULE_0__utils_js__["a" /* DIRECTION */].NONE;

    // align right if delete at right
    return (this.oldSelection.end === this.cursorPos || this.oldSelection.start === this.cursorPos) &&
    // if not range removed (event with backspace)
    this.oldSelection.end === this.oldSelection.start ? __WEBPACK_IMPORTED_MODULE_0__utils_js__["a" /* DIRECTION */].RIGHT : __WEBPACK_IMPORTED_MODULE_0__utils_js__["a" /* DIRECTION */].LEFT;
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pattern_js__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__range_js__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_holder_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__rollupPluginBabelHelpers_6b3bd404_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__base_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__core_continuous_tail_details_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pattern_input_definition_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__factory_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pattern_fixed_definition_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pattern_chunk_tail_details_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pattern_cursor_js__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__regexp_js__ = __webpack_require__(48);
...
/** Date mask */
class MaskedDate extends __WEBPACK_IMPORTED_MODULE_0__pattern_js__["a" /* default */] {
...
MaskedDate.GET_DEFAULT_BLOCKS = () => ({
  d: {
    mask: __WEBPACK_IMPORTED_MODULE_1__range_js__["a" /* default */],
    from: 1,
    to: 31,
    maxLength: 2
  },
...
__WEBPACK_IMPORTED_MODULE_2__core_holder_js__["a" /* default */].MaskedDate = MaskedDate;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__html_mask_element_js__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_holder_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mask_element_js__ = __webpack_require__(63);




class HTMLContenteditableMaskElement extends __WEBPACK_IMPORTED_MODULE_0__html_mask_element_js__["a" /* default */] {
  /**
    Returns HTMLElement selection start
    @override
  */
...
__WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].HTMLContenteditableMaskElement = HTMLContenteditableMaskElement;
...
var _swiperBundle = __webpack_require__(362);
...
var _imask = __webpack_require__(371);
...
var header = function () {
        ...
        menu.addEventListener('click', function (e) {
            ...
            if (window.matchMedia("(min-width: 1199px)").matches) {
                if (e.target.classList.contains('dropdown-title')) {
                    e.preventDefault();
                    dropdownTitle.forEach(function (item, i) {
                        if (e.target == item) {
                ...
                if (e.target.classList.contains('submenu__item-header')) {
                    subMenuItem.forEach(function (item, i) {
                        if (e.target == item) {
                ...
                if (parent.classList.contains('submenu__tabs')) {
                    subMenuTabs.forEach(function (item, i) {
                        if (item == parent) {
                            tabIntex = i;
                            for (var j = 0; j < 2; j++) {
    ...
    var menuMobile = document.querySelector('.header__main');
    ...
    var parent = $('.dropdown__service-menu');
    ...
    $('[data-modal-video]').click(function () {
        new _modal2.default($('.jsModalVideo')).show($(this));
...
var sliders = function () {
    var swiper = new _swiperBundle2.default('.diseases__slider', {
        autoHeight: true,
        slidesPerView: 1,
        pagination: {
    ...
    var swiper2 = new _swiperBundle2.default('.awards__slider', {
        autoHeight: true,
        slidesPerView: 3,
        spaceBetween: 30,
        pagination: {
    ...
    var swiper3 = new _swiperBundle2.default('.equipment__slider', {
        autoHeight: true,
        slidesPerView: 3,
        spaceBetween: 30,
        pagination: {
    ...
    var swiper4 = new _swiperBundle2.default('.reviews__slider', {
        autoHeight: true,
        slidesPerView: 3,
        spaceBetween: 30,
        pagination: {
    ...
    var swiper5 = new _swiperBundle2.default('.reviews__slider-text', {
        autoHeight: true,
        slidesPerView: 3,
        spaceBetween: 30,
        pagination: {
    ...
    var swiper6 = new _swiperBundle2.default('.gallery__slider', {
        autoHeight: true,
        slidesPerView: 3,
        spaceBetween: 30,
        pagination: {
    ...
    var swiper7 = new _swiperBundle2.default('.allcenter-gallery__slider', {
        autoHeight: true,
        slidesPerView: 3,
        spaceBetween: 30,
        pagination: {
    ...
    var swiper8 = new _swiperBundle2.default('.nn_center-gallery__slider', {
        autoHeight: true,
        slidesPerView: 3,
        spaceBetween: 30,
        pagination: {
    ...
    var swiper9 = new _swiperBundle2.default('.stages__steps-mobile', {
        autoHeight: true,
        slidesPerView: 1,
        spaceBetween: 20,
        pagination: {
    ...
    var swiper10 = new _swiperBundle2.default('.reviews__video-mobile', {
        autoHeight: true,
        slidesPerView: 1,
        spaceBetween: 20,
        pagination: {
    ...
    var swiper11 = new _swiperBundle2.default('.promotion__sale-mobile', {
        autoHeight: true,
        slidesPerView: 1,
        spaceBetween: 20,
        pagination: {
    ...
    var swiper12 = new _swiperBundle2.default('.articles__swiper', {
        autoHeight: true,
        slidesPerView: 1,
        spaceBetween: 20,
        pagination: {
    ...
    var swiper13 = new _swiperBundle2.default('.stages__steps-btn__mobile', {
        autoHeight: true,
        slidesPerView: 1,
        spaceBetween: 20,
        pagination: {
    ...
    var sliderFraction = document.querySelectorAll('.swiper-pagination-fraction');
    sliderFraction.forEach(function (item) {
        if (item) {
...
var accordion = function () {
    ...
    document.querySelectorAll('.accordion__item-header').forEach(function (item) {
...
var tabsContact = function () {

    var tabsParent = document.querySelector('.contacts-tabheader__items'),
...
var buttons = function () {
    ...
    if (moreBtn) {
        ...
        var texts = document.querySelector('.specialists__text').children;
        moreBtn.addEventListener('click', function (e) {

            var spanText = e.target.children[0].textContent;
            ...
            if (spanText == 'Читать дальше') {
                ...
                for (var _i = 2; _i < texts.length; _i++) {
                    texts[_i].style.display = 'none';
                }
...
var inputPhoneMask = function () {
    ...
    if (inputPhone) {
        ...
        inputPhone.forEach(function (item) {
            var mask = new _imask2.default(item, maskOptions);
        });
    }
}();
...
var visuallyImpaired = function () {
    ...
    html.addEventListener('click', function () {
        if (html.classList.contains('special')) {
            ...
            var specialImages = html.querySelector('.special-images');
            var button = specialImages.querySelector('button');
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["$"] = __webpack_require__(360);
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["jQuery"] = __webpack_require__(361);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(62)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["Util"] = __webpack_require__(369);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(62)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__controls_input_js__ = __webpack_require__(372);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__masked_base_js__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__masked_pattern_js__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__masked_enum_js__ = __webpack_require__(373);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__masked_range_js__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__masked_number_js__ = __webpack_require__(374);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__masked_date_js__ = __webpack_require__(246);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__masked_regexp_js__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__masked_function_js__ = __webpack_require__(375);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__masked_dynamic_js__ = __webpack_require__(376);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__masked_factory_js__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__controls_mask_element_js__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__controls_html_mask_element_js__ = __webpack_require__(85);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__controls_html_contenteditable_mask_element_js__ = __webpack_require__(247);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__masked_pipe_js__ = __webpack_require__(377);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__core_change_details_js__ = __webpack_require__(7);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "ChangeDetails", function() { return __WEBPACK_IMPORTED_MODULE_16__core_change_details_js__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__rollupPluginBabelHelpers_6b3bd404_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__core_action_details_js__ = __webpack_require__(245);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__core_continuous_tail_details_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__masked_pattern_input_definition_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__masked_pattern_fixed_definition_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__masked_pattern_chunk_tail_details_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__masked_pattern_cursor_js__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__rollupPluginBabelHelpers_6b3bd404_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_action_details_js__ = __webpack_require__(245);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__masked_date_js__ = __webpack_require__(246);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__masked_factory_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__mask_element_js__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__html_mask_element_js__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__html_contenteditable_mask_element_js__ = __webpack_require__(247);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__core_holder_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__masked_pattern_js__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__masked_base_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__core_continuous_tail_details_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__masked_pattern_input_definition_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__masked_pattern_fixed_definition_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__masked_pattern_chunk_tail_details_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__masked_pattern_cursor_js__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__masked_regexp_js__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__masked_range_js__ = __webpack_require__(84);
...
class InputMask {
  ...
  */
  ...
  set mask(mask) {
    ...
    const masked = Object(__WEBPACK_IMPORTED_MODULE_4__masked_factory_js__["a" /* default */])({
      mask
    });
  ...
  */
  ...
  updateOptions(opts) {
    const {
      ...
      restOpts = Object(__WEBPACK_IMPORTED_MODULE_0__rollupPluginBabelHelpers_6b3bd404_js__["a" /* _ */])(opts, _excluded);
    const updateMask = !this.maskEquals(mask);
    const updateOpts = !Object(__WEBPACK_IMPORTED_MODULE_1__core_utils_js__["f" /* objectIncludes */])(this.masked, restOpts);
  ...
  */
  ...
  _onInput(e) {
    ...
    const details = new __WEBPACK_IMPORTED_MODULE_2__core_action_details_js__["a" /* default */](
    // new state
    ...
    const removeDirection = oldRawValue === this.masked.rawInputValue ? details.removeDirection : __WEBPACK_IMPORTED_MODULE_1__core_utils_js__["a" /* DIRECTION */].NONE;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pattern_js__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_holder_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__rollupPluginBabelHelpers_6b3bd404_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__base_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_continuous_tail_details_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pattern_input_definition_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__factory_js__ = __webpack_require__(24);
...
class MaskedEnum extends __WEBPACK_IMPORTED_MODULE_0__pattern_js__["a" /* default */] {
  /**
    @override
    @param {Object} opts
  */
...
__WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].MaskedEnum = MaskedEnum;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_holder_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_continuous_tail_details_js__ = __webpack_require__(12);
...
*/
class MaskedNumber extends __WEBPACK_IMPORTED_MODULE_2__base_js__["a" /* default */] {
  /** Single char */
  ...
  */
  ...
  _updateRegExps() {
    ...
    let mid = '\\d*';
    let end = (this.scale ? "(".concat(Object(__WEBPACK_IMPORTED_MODULE_0__core_utils_js__["b" /* escapeRegExp */])(this.radix), "\\d{0,").concat(this.scale, "})?") : '') + '$';
    this._numberRegExp = new RegExp(start + mid + end);
    this._mapToRadixRegExp = new RegExp("[".concat(this.mapToRadix.map(__WEBPACK_IMPORTED_MODULE_0__core_utils_js__["b" /* escapeRegExp */]).join(''), "]"), 'g');
    this._thousandsSeparatorRegExp = new RegExp(Object(__WEBPACK_IMPORTED_MODULE_0__core_utils_js__["b" /* escapeRegExp */])(this.thousandsSeparator), 'g');
  }
  ...
  */
  doPrepare(ch) {
    ...
    */
    ...
    const [prepCh, details] = Object(__WEBPACK_IMPORTED_MODULE_0__core_utils_js__["e" /* normalizePrepare */])(super.doPrepare(ch, flags));
  ...
  */
  nearestInputPos(cursorPos, direction) {
    ...
    switch (direction) {
      case __WEBPACK_IMPORTED_MODULE_0__core_utils_js__["a" /* DIRECTION */].NONE:
      case __WEBPACK_IMPORTED_MODULE_0__core_utils_js__["a" /* DIRECTION */].LEFT:
      case __WEBPACK_IMPORTED_MODULE_0__core_utils_js__["a" /* DIRECTION */].FORCE_LEFT:
        {
          const separatorAtLeftPos = this._findSeparatorAround(cursorPos - 1);
          if (separatorAtLeftPos >= 0) {
            const separatorAtLeftEndPos = separatorAtLeftPos + this.thousandsSeparator.length;
            if (cursorPos < separatorAtLeftEndPos || this.value.length <= separatorAtLeftEndPos || direction === __WEBPACK_IMPORTED_MODULE_0__core_utils_js__["a" /* DIRECTION */].FORCE_LEFT) {
              return separatorAtLeftPos;
            }
          }
          break;
        }
      case __WEBPACK_IMPORTED_MODULE_0__core_utils_js__["a" /* DIRECTION */].RIGHT:
      case __WEBPACK_IMPORTED_MODULE_0__core_utils_js__["a" /* DIRECTION */].FORCE_RIGHT:
        {
...
MaskedNumber.EMPTY_VALUES = [...__WEBPACK_IMPORTED_MODULE_2__base_js__["a" /* default */].EMPTY_VALUES, 0];
__WEBPACK_IMPORTED_MODULE_3__core_holder_js__["a" /* default */].MaskedNumber = MaskedNumber;
...
class MaskedFunction extends __WEBPACK_IMPORTED_MODULE_0__base_js__["a" /* default */] {
  /**
    @override
    @param {Object} opts
  */
...
__WEBPACK_IMPORTED_MODULE_1__core_holder_js__["a" /* default */].MaskedFunction = MaskedFunction;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_change_details_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__factory_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_holder_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_continuous_tail_details_js__ = __webpack_require__(12);
...
class MaskedDynamic extends __WEBPACK_IMPORTED_MODULE_4__base_js__["a" /* default */] {
  ...
  */
  _update(opts) {
    ...
    if ('mask' in opts) {
      ...
      this.compiledMasks = Array.isArray(opts.mask) ? opts.mask.map(m => Object(__WEBPACK_IMPORTED_MODULE_3__factory_js__["a" /* default */])(m)) : [];
  ...
  */
  doPrepare(str) {
    let flags = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    let [s, details] = Object(__WEBPACK_IMPORTED_MODULE_1__core_utils_js__["e" /* normalizePrepare */])(super.doPrepare(str, flags));
    if (this.currentMask) {
      let currentDetails;
      [s, currentDetails] = Object(__WEBPACK_IMPORTED_MODULE_1__core_utils_js__["e" /* normalizePrepare */])(super.doPrepare(s, this.currentMaskFlags(flags)));
  ...
  */
  ...
  set skipInvalid(skipInvalid) {
    if (this.isInitialized || skipInvalid !== __WEBPACK_IMPORTED_MODULE_4__base_js__["a" /* default */].DEFAULTS.skipInvalid) {
  ...
  maskEquals(mask) {
    return Array.isArray(mask) && this.compiledMasks.every((m, mi) => {
      ...
      const _mask$mi = mask[mi],
        ...
        restOpts = Object(__WEBPACK_IMPORTED_MODULE_0__rollupPluginBabelHelpers_6b3bd404_js__["a" /* _ */])(_mask$mi, _excluded2);
      return Object(__WEBPACK_IMPORTED_MODULE_1__core_utils_js__["f" /* objectIncludes */])(m, restOpts) && m.maskEquals(oldMask);
    });
  }
...
MaskedDynamic.DEFAULTS = {
  dispatch: (appended, masked, flags, tail) => {
    ...
    const inputs = masked.compiledMasks.map((m, index) => {
      ...
      const startInputPos = isCurrent ? m.value.length : m.nearestInputPos(m.value.length, __WEBPACK_IMPORTED_MODULE_1__core_utils_js__["a" /* DIRECTION */].FORCE_LEFT);
      ...
      return {
        ...
        totalInputPositions: m.totalInputPositions(0, Math.max(startInputPos, m.nearestInputPos(m.value.length, __WEBPACK_IMPORTED_MODULE_1__core_utils_js__["a" /* DIRECTION */].FORCE_LEFT)))
      };
    });
...
__WEBPACK_IMPORTED_MODULE_5__core_holder_js__["a" /* default */].MaskedDynamic = MaskedDynamic;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__factory_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_holder_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_utils_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_change_details_js__ = __webpack_require__(7);
...
function createPipe(mask) {
  ...
  const masked = Object(__WEBPACK_IMPORTED_MODULE_0__factory_js__["a" /* default */])(mask);
